...
class BridgeValidator:
    ...
    def validate_monitoring_config(self) -> bool:
        ...
        dashboard_file = (
            self.bridges_dir / "telegram_super_tma" / "grafana_dashboard.json"
        )
        ...
        metrics_file = self.bridges_dir / "telegram_super_tma" / "prometheus_metrics.py"
        ...
        # Check alert rules
        alert_file = self.bridges_dir / "telegram_super_tma" / "alert_rules.yml"
...
def main():
    ...
    parser.add_argument("--dir", default="bridges", help="Path to bridges directory")
