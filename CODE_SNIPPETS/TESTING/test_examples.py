...
class TestBridgeConfig:
    ...
    def test_rate_limit_config(self):
        ...
        rate_limit = {"enabled": True, "requests_per_second": 50.0, "burst_size": 100}
...
class TestCircuitBreaker:
    ...
    def test_failure_threshold(self):
        ...
        config = {"failure_threshold": 5, "timeout": 60.0}
...
class TestRateLimiter:
    ...
    def test_token_bucket(self):
        ...
        config = {"rate": 10.0, "capacity": 20}  # tokens per second  # max tokens
...
class TestMetrics:
    ...
    def test_gauge_value(self):
        ...
        gauge = {"rooms_bridged": 5, "users_connected": 100, "queue_size": 10}
